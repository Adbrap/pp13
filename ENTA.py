        ...
        if passed2 == True:
            ...
            if passed3 == True:
                ...
                if (C - B) < (C - D) and (C - B) < (E - D) and B > D and F > D and B < C and F < E and A >= \
                    ...
                    if I[1] > B and moyenne_epaule1 <= moyenne_tete / 2 and moyenne_epaule1 >= moyenne_tete / 4 and  accept == True and G >= 1 and G <= D + (moyenne_tete / 2) and G >= D + (moyenne_tete / 4) and G > F and G <= mirande2['c'].values[3]:
                        # ----- condition pour filtrer iete  -----#
